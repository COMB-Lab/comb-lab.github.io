...
<div style="width: 220px; text-align: left;">
  ...
  <div style="width: 260px; text-align: left;">
    <img src="/images/Nikita.jpeg" alt="Dikshant Sagar" style="width: 200px; height: 260px; object-fit: cover; border-radius: 4px;margin-top: 3px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    <p style="margin:0; font-weight: 600;">Nikita Mishra</p>
    <p style="margin: 0;text-align:left;font-size: 16px;">Undergraduate Student in Chemistry and Biochemistry, 2021-2022</p>
    <p style="margin: 0;text-align:left;font-size: 16px;">Current Position: Master's Student in Bioengerring, Stanford University</p>
  </div>

  <div style="width: 220px; text-align: left;">
    <img src="/images/Sahar.jpeg" alt="" style="width: 200px; height: 260px; object-fit: cover; border-radius: 4px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    <p style="margin:0; font-weight: 600;">Sahar Cain</p>
    <p style="margin: 0;text-align:left;font-size: 16px;white-space: nowrap;">Master's Student in Computer Science,</p>
    <p style="margin: 0;text-align:left;font-size: 16px;">2021-2022</p>
    <p style="margin: 0;text-align:left;font-size: 16px;white-space: nowrap;">Current Job: Lead Data Scientist at</p>
    <p style="margin: 0;text-align:left;font-size: 16px;">Mogul Hospitality</p>
  </div>

  <div style="width: 220px; text-align: left;">
    <img src="/images/izzy.jpeg" alt="" style="width: 200px; height: 260px; object-fit: cover; border-radius: 4px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    <p style="margin:0; font-weight: 600;white-space: nowrap;">Isabella Apuya Marcelette Perez</p>
    <p style="margin: 0;text-align:left;font-size: 16px;white-space: nowrap;">Undergraduate Research Assistant (2023)</p>
     <p style="margin: 0;text-align:left;font-size: 16px;white-space: nowrap;">Biochemistry and Biophysics</p>
    <p style="margin: 0;text-align:left;font-size: 16px;white-space: nowrap;">El Camino Community College District</p>
  </div>
  <div style="width: 220px; text-align: left;">
    <img src="/images/Nida.jpeg" alt="" style="width: 200px; height: 260px; object-fit: cover; border-radius: 4px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    <p style="margin:0; font-weight: 600;white-space: nowrap;">Nida Sheikh</p>
    <p style="margin: 0;text-align:left;font-size: 16px;white-space: nowrap;">Undergraduate Research Assistant (2023)</p>
    <p style="margin: 0;text-align:left;font-size: 16px;white-space: nowrap;">Department of Computer Science</p>
    <p style="margin: 0;text-align:left;font-size: 16px;white-space: nowrap;">California State University, Los Angeles</p>
  </div>

<div style="width: 220px; text-align: left;">
    <img src="/images/Deepanker.jpeg" alt="" style="width: 200px; height: 260px; object-fit: cover; border-radius: 4px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    <p style="margin:0; font-weight: 600;white-space: nowrap;">Deepanker Seth</p>
    <p style="margin: 0;text-align:left;font-size: 16px;white-space: nowrap;">Undergraduate Research Assistant (2022)</p>
    <p style="margin: 0;text-align:left;font-size: 16px;white-space: nowrap;">Department of Computer Science</p>
    <p style="margin: 0;text-align:left;font-size: 16px;white-space: nowrap;">California State University, Los Angeles</p>
  </div>
